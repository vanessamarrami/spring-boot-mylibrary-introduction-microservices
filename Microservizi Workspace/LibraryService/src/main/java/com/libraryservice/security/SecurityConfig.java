		...
		http
		 ...
		 .formLogin((formLogin) ->
			formLogin
				...
				.defaultSuccessUrl("http://localhost:8765/LIBRARYSERVICE/")
				.failureUrl("http://localhost:8765/LIBRARYSERVICE/login?error=true")
		)
		 .logout((logout) ->
			logout
				.logoutUrl("/logout")
				.logoutSuccessUrl("http://localhost:8765/LIBRARYSERVICE/")
		);
		return http.build();
	}
